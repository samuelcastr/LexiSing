...
- **400+ señas de palabras** reconocidas (incluye léxico empresarial) + **27 letras** del abecedario dactilológico LSC para deletreo
...
## 📊 Catálogo Completo de Señas (400+)

### Integrado en `GESTO_PALABRA` dentro de `sign-language.service.ts`

| Categoría | Cantidad | Ejemplos |
|-----------|----------|----------|
| **Saludos y Presentaciones** | 15 | Hola, Buenos días, Sí, No, Adiós, Mucho gusto, Por favor, Gracias, Con permiso, Disculpe, Perdón, Te quiero |
| **Números** | 20+ | Cero a Diez, Veinte, Treinta, Cuarenta, Cincuenta, Cien, Mayor/Menor/Igual que |
| **Tiempos y Horarios** | 12 | Hora, Ahora, Hoy, Mañana, Ayer, Esta semana, Este mes, Este año, Pronto, Tiempo libre, Descanso, Hora extra |
| **Personas y Cargos** | 20 | Jefe, Supervisor, Gerente, Director, Empleado, Asistente, Secretaria, Cliente, Proveedor, Entrevistador, Candidato, Compañeros, Equipo |
| **Comunicación y Reuniones** | 14 | Hablar, Escuchar, Reunión, Participar, Opinión, Consenso, Discusión, Presentación, Informe, Email, Llamada, Conferencia |
| **Tareas y Acciones Laborales** | 35 | Trabajar, Producir, Vender, Comprar, Servir, Organizar, Planificar, Ejecutar, Supervisar, Evaluar, Calificar, Investigar, Analizar, Enviar, Recibir, Aprobar, Rechazar, Priorizar, Asignar, Delegar, Colaborar, Coordinar, Liderar, Resolver |
| **Objetos y Tecnología** | 40 | Computadora, Teclado, Ratón, Monitor, Teléfono, Impresora, Escritorio, Silla, Archivero, Papel, Bolígrafo, Cuaderno, Marcador, Proyector, Pizarra, Cámara, Audífonos, Memoria USB, Cargador, Nube, PDF, Hoja de cálculo, Chat, Notificación |
| **Documentos y Trámites** | 22 | Documento, Contrato, Firma, Identificación, Curriculum, Carta, Factura, Recibo, Presupuesto, Nómina, Certificado, Constancia, Formulario, Póliza, Código de conducta, Confidencialidad |
| **Ubicaciones** | 18 | Oficina, Sala de reuniones, Recepción, Pasillo, Baño, Cafetería, Estacionamiento, Almacén, Laboratorio, Planta, Gerencia, Puerta, Ventana, Cubículo, Escalera, Ascensor |
| **Situaciones Laborales** | 27 | Entrevista, Prueba técnica, Evaluación, Ascenso, Bono, Permiso, Vacaciones, Licencia, Incapacidad, Retiro, Renuncia, Despido, Prácticas, Contrato temporal/indefinido, Capacitación, Taller, Congreso, Feria, Networking, Teletrabajo, Home office |
| **Herramientas Digitales** | 16 | Enviar, Recibir, Adjuntar, Responder, Reenviar, Borrar, Spam, Firma digital, Subir, Descargar, Copiar y pegar, Buscar, Configuración, Videollamada |
| **Emergencias** | 13 | Emergencia, Peligro, Socorro, Incendio, Evacuación, Salida de emergencia, Extintor, Botiquín, Lesión, Accidente, Riesgo, Bombero, Ambulancia |
| **Salud y Bienestar** | 10 | Dolor, Dolor de cabeza, Dolor de espalda, Fatiga, Cansancio, Enfermo, Medicina, Ejercicio, Agua, Ergonomía |
| **Emociones** | 18 | Felicidad, Tristeza, Enojo, Preocupación, Orgullo, Frustración, Confusión, Sorpresa, Calma, Nervios, Motivación, Entusiasmo, Respeto, Confianza, Empatía, Tolerancia, Solidaridad, Profesionalismo |
| **Léxico Bimanual** | 12 | Oración, Parar, Paz, Aplauso, Amor, Reunión, Informe, Pausa, Aprobar, Enviar, Trabajar, Pedir |
| **Letras Dactilológicas LSC** | 27 | A, B, C, D, E, F, G, H, I, J, K, L, M, N, Ñ, O, P, Q, R, S, T, U, V, W, X, Y, Z |

**Total: ~400 señas funcionales** integradas en el diccionario `GESTO_PALABRA`.

---

## Señas soportadas (Detalle Original)
